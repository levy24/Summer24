...
document.querySelector(".logout").addEventListener('click',()=>{
    window.location.href='/TodoList/login/index.html';
})
...
function checkInput(input) {
    ...
    if (text === "") {
        ...
        const inputDateTime = new Date(text);
...
function updateTask() {
    ...
    task.reminderTime = new Date(document.getElementById('reminder').value).getTime(); 
    task.lastReminderTime = task.reminderTime; 
